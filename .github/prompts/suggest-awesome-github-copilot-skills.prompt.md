...
2. **Scan Local Skills**: Discover existing skill folders in `.claude/skills/` folder
...
12. **Download/Update Assets**: For requested skills, automatically:
    - Download new skills to `.claude/skills/` folder, preserving the folder structure
